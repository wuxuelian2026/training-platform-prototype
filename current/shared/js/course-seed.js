...
export const teacherAccounts = [
  { id: 'teacher-wang', name: '王玥', no: 'JS20260901', unit: '湖北艺术职业学院', title: '副教授', professional: '舞蹈表演', years: '8年' },
  { id: 'teacher-chen', name: '陈晨', no: 'JS20260902', unit: '湖北艺术职业学院', title: '讲师', professional: '声乐演唱', years: '5年' }
];
...
export function applicationSeed() {
  return [
    ...
    { id: 'CR-2026-0003', name: '少儿国画入门', type: '面授课程', major: '中国画', professional: '美术教育', hours: 20, status: '审核中', date: '2026-09-06', submittedAt: '2026-09-06 11:20', intro: '以笔墨体验和传统题材临摹为主，适合零基础少儿建立国画兴趣。', attachment: '', file: '', teacher: '李青', teacherNo: 'JS20260903', teacherUnit: '武汉美术馆', teacherTitle: '讲师', teacherProfessional: '美术教育', teacherInfo: '李青 · 讲师 · 美术教育 · 武汉美术馆', difficulty: '启蒙', ages: ['少儿'], courseId: 'COURSE-CR-2026-0003', review: '', reviewedBy: '', reviewedAt: '' },
