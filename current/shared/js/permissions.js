...
export const PERMISSION_POINTS = [
  ...
  { id: 'PERM-CRM-001', module: '面授招生与CRM', object: '班级', action: '查看', scopes: TEACHING, note: '查看面授班级列表与详情' },
  { id: 'PERM-CRM-002', module: '面授招生与CRM', object: '班级', action: '发布与上下架', scopes: TEACHING, note: '发布班级、定价与报名窗口、上下架' },
  { id: 'PERM-CRM-003', module: '面授招生与CRM', object: '批次', action: '批次管理', scopes: TEACHING, note: '维护招生批次与班级归属' },
  { id: 'PERM-CRM-004', module: '面授招生与CRM', object: '试听', action: '试听登记', scopes: TEACHING, note: '登记试听、确认与试听结果' },
  { id: 'PERM-CRM-005', module: '面授招生与CRM', object: '线索', action: '线索跟进', scopes: ['all', 'campus', 'self'], note: '跟进线索、记录沟通与下次跟进' },
  { id: 'PERM-CRM-006', module: '面授招生与CRM', object: '报名转化', action: '转化登记', scopes: ['all', 'campus', 'self'], note: '登记报名转化结果' },
  ...
  { id: 'PERM-ACADEMIC-001', module: '教务执行监管', object: '场地', action: '场地管理', scopes: TEACHING, note: '场地档案维护与批量导入' },
  { id: 'PERM-ACADEMIC-002', module: '教务执行监管', object: '排班', action: '排班管理', scopes: TEACHING, note: '创建班级排班、保存草稿与发布' },
  { id: 'PERM-ACADEMIC-003', module: '教务执行监管', object: '课表', action: '课表管理', scopes: TEACHING, note: '课表矩阵查看与导出' },
