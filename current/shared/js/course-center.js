...
const statusClass = status => ({ '审核中': 'brand', '已通过': 'green', '已驳回': 'red', '已撤销': 'gray', '待编排': 'gray', '编排中': 'amber', '已完成': 'green', '不适用': 'gray', '启用': 'green', '停用': 'gray' }[status] || 'brand');
